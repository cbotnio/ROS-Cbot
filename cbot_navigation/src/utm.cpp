/*
******************************** CLASS ************************************
 => Class for converting lat-long to utm co-ordinates and vice versa
***************************************************************************
*/
...
void UTM::LLtoUTM(int ReferenceEllipsoid, const double Lat, const double Long, double *UTMNorthing, double *UTMEasting, char* UTMZone)
{
    ...
    *UTMNorthing = (double)(k0 * (M + N * tan(LatRad) * (A * A / 2 + (5 - T + 9 * C + 4 * C * C) * A * A * A * A / 24 + (61 - 58 * T + T * T + 600 * C - 330 * eccPrimeSquared)
                                  * A * A * A * A * A * A / 720)));
    if (Lat < 0)
      *UTMNorthing += 10000000.0; //10000000 meter offset for southern hemisphere
}

char UTM::UTMLetterDesignator(double Lat)
{
...
void UTM::UTMtoLL(int ReferenceEllipsoid, const double UTMNorthing, const double UTMEasting, const char* UTMZone,
