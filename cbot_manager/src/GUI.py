...
buttons = [[sg.Frame(layout=[
                [sg.Checkbox('AUV', default=False, key='AUV_mode',enable_events=True),
                 sg.Checkbox('ROV', default=True, key='Teleop_mode')]],
            ...
            [sg.Frame(layout=[
                [sg.Checkbox('Heading Control\t',disabled=True, default=False, key='HeadingControlON',enable_events=True),
                 sg.T('Heading Angle:', pad=((1,0),0)), sg.Spin(values=[i for i in range(-360,360)],initial_value=0,size=(10,1),disabled=True, background_color='white', text_color='black',key="HCtrl")],
                [sg.Checkbox('Pitch Control\t',disabled=True, default=False, key='PitchControlON',enable_events=True),
                 sg.T('Pitch Angle:', pad=((1,0),0)), sg.Spin(values=[i for i in range(-360,360)],initial_value=0,size=(10,1), disabled=True, background_color='white', text_color='black',key="PCtrl")],
                [sg.Checkbox('Depth Control\t',disabled=True, default=False, key='DepthControlON',enable_events=True),
                 sg.T('Depth:', pad=((1,0),0)), sg.Spin(values=[i for i in range(-360,360)],initial_value=0.0,size=(10,1), disabled=True, background_color='white', text_color='black',key="DCtrl")],
                [sg.Checkbox('Speed Control\t',disabled=True, default=False, key='SpeedControlON',enable_events=True),
                 sg.T('Speed:', pad=((1,0),0)), sg.Spin(values=[i for i in range(-360,360)],initial_value=0.0,size=(10,1), disabled=True, background_color='white', text_color='black',key="SCtrl")],],
...
while True:
    ...
    window.Element("Thruster_M1").Update(disabled=(values["THRUSTERS_ON"]==0 or values["CONTROLLER_ON"]!=0))
    window.Element("Thruster_M2").Update(disabled=(values["THRUSTERS_ON"]==0 or values["CONTROLLER_ON"]!=0))
